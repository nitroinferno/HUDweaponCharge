...
I.Settings.registerGroup {
	key = "SettingsPlayer" .. modInfo.name .. "Position",
	page = modInfo.name,
	order = 0,
	l10n = modInfo.name,
	name = "Position",
	...
	settings = {
		...
		setting("xPos", "number", {integer = true, disabled = true}, "X Position", nil, ''),
		setting("yPos", "number", {integer = true, disabled = true}, "Y Position", nil, ''),
